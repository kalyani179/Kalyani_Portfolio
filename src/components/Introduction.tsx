...
export function Introduction() {
  ...
  return (
    <section
      id="intro"
      className="min-h-screen max-sm:min-h-0 flex flex-col justify-start pt-16 px-6 pb-20 max-sm:pt-14 max-sm:px-4 max-sm:pb-14 transition-colors duration-300"
    >
